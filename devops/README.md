...
You need either a Ubuntu or Debian based system for paipoeta.com.br, enable SSH, and install a supported version of Python 3 on that system.
...
Deploy the stack defined in `devops/stacks/paipoeta.com.br.yml` to the remote server with:
