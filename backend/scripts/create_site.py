...
from lx.paipoeta.interfaces import IBrowserLayer
...
if site_id not in app.objectIds():
    ...
    portal_setup.runAllImportStepsFromProfile("profile-lx.paipoeta:default")
    transaction.commit()

    if EXAMPLE_CONTENT:
        portal_setup.runAllImportStepsFromProfile("profile-lx.paipoeta:initial")
        transaction.commit()
    app._p_jar.sync()
